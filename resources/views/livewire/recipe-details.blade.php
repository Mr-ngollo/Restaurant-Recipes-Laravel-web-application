<div>
    ...
    <div class="flex gap-5 p-20">
        <img src="{{ asset('assets/images/2.jpg') }}" alt="Recipe1 picture" class="rounded object-cover" height="400px"
            width="400px">
        <div>
            ...
            <div
                class="flex cursor-pointer justify-center gap-2 w-full bg-green-800 text-center rounded px-12 py-2  hover:bg-green-900 text-sm font-medium text-white shadow focus:outline-none focus:ring active:bg-green-700 sm:w-auto">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <div class="mt-10">
                    ...
                    <div class="mt-4">
                        <ul role="list" class="list-disc space-y-2 pl-4 text-sm">
                            ...
                            <li class="text-gray-400"><span class="text-gray-600">25min - 40min</span>
                            </li>

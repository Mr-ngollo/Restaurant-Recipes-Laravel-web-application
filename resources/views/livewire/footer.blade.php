    ...
    <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <ul class="mt-8 flex justify-start gap-6 sm:mt-0 sm:justify-end">
                ...
                <li>
                    <a href="/instagram.com/ngollo_official" rel="noreferrer" target="_blank"
                        class="text-gray-700 transition hover:opacity-75">
                ...
                <li>
                    <a href="/github.com/Mr-ngollo" rel="noreferrer" target="_blank"
                        class="text-gray-700 transition hover:opacity-75">
        ...
        <p class="text-xs text-gray-500">&copy; 2025. Developed by ngollo.dev . All rights reserved.</p>
    </div>
</footer>

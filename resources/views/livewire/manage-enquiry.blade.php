                    ...
                    <div class="flex">
                        <div class="relative w-full">
                            ...
                            <input wire:model.live.debounce.300ms = "search" type="text"
                                ...
                                placeholder="Search enquiries..." required="">
                        </div>
                    </div>
                    <div class="flex space-x-3">
                        <div class="flex space-x-3 items-center">
                            <label class="w-40 text-sm font-medium text-gray-900">User Type :</label>
                            <select wire:model="role_filter"
                        ...
                        <tbody>
                            @foreach ($enquiries as $enquiry)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">{{ $enquiry->email }}</td>
                                    <td class="px-4 py-3">{{ $enquiry->phone_number }}</td>
                                    <td class="px-4 py-3">{{ Str::limit($enquiry->message, 50) }}</td>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="p-4 md:p-5 text-center">
                                                        ...
                                                        <button wire:click="deleteEnquiry" type="button"

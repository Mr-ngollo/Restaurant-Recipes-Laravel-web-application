            ...
            <form wire:submit="update">
                ...
                <div
                    ...
                    <div class="sm:col-span-9">
                        <div>
                            <input type="text" wire:model="recipe_name" id="af-submit-application-full-name"
                    ...
                    <div class="sm:col-span-9">
                        <input id="af-submit-application-email" wire:model="recipe_price" type="text"
                            inputmode="decimal" pattern="[0-9]*[.,]?[0-9]*"
                            class="py-2 px-3 pe-11 block w-full  shadow-sm text-sm rounded-lg focus:border-green-500 focus:ring-green-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                        @error('recipe_price')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="sm:col-span-9">
                        <select wire:model="category_id"
                            class="py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-green-500 focus:ring-green-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                            <option selected="">Select Product Category</option>
                            @foreach ($all_categories as $category)
                                <option value="{{ $category->id }}" wire:key="{{ $category->id }}"
                                    {{ $recipe_details->category_id == $category->id ? 'selected' : '' }}>
                ...
                <div
                    ...
                    <div class="sm:col-span-9">
                        @if ($photo && is_string($photo))
                            <img src="{{ asset('storage/' . str_replace('public/', '', $photo)) }}" alt="Recipe image"
                                height="300px" width="300px" class="rounded-lg">
                        @elseif ($photo)
                            <img src="{{ $photo->temporaryUrl() }}" alt="Recipe image" height="300px" width="300px"
                                class="rounded-lg">
                        @else
